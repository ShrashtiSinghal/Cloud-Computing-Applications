...
public class PopularityLeague extends Configured implements Tool {
    ...
    public static class TopLinksReduce extends Reducer<NullWritable, Text, IntWritable, IntWritable> {
        ...
        TreeMap<Integer, Integer> toSort1 = new TreeMap<Integer,Integer>(Collections.reverseOrder());
//	TreeMap<Integer, Integer> nmap = toSort1.descendingMap();    
        @Override
        protected void setup(Context context) throws IOException,InterruptedException {
            Configuration conf = context.getConfiguration();
            this.N = conf.getInt("N", 10);
	 ...
	 //    int b=Integer.valueOf(ZERO);   
          //  toSort1.put(a,b);
            for(int i = 0;i < toSort.size();i++){
                ...
                toSort1.put((e.second), (rank));
	
            }//System.out.println(toSort1);

	/*	Set set = toSort1.entrySet();
	...
	//	Collections.sort(toSort1, Collections.reverseOrder());


//		NavigableMap nmap = toSort1.descendingMap();
//		context.write(new IntWritable(nmap));
		for(Map.Entry<Integer,Integer> entry : toSort1.entrySet()) {
